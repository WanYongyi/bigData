# -*- coding: utf-8 -*-
"""
Created on Wed May 15 10:05:23 2024
...
# 3-13 6×5随机矩阵的describe
import numpy as np
D = pd.DataFrame(np.random.randn(6, 5))  # 产生6×5随机矩阵
print(D.describe())


# 3-14 pandas累积统计特征函数、移动窗口统计函数示例
